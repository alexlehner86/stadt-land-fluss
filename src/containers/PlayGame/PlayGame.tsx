    ...
    public render() {
        ...
        return (
            <PubNubProvider client={this.pubNubClient}>
                ...
                {/* Hide main content if loading screen is shown, except for fillOutTextfields phase. */}
                {!this.state.showLoadingScreen || this.state.currentPhase === GamePhase.fillOutTextfields ? (
